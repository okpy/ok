...
debug_js = Bundle(
    'https://unpkg.com/tota11y@0.1.5/index.js',
...
common_css = Bundle(
    ...
    'https://unpkg.com/browse/ionicons@4.2.4/dist/css/ionicons.css',
...
student_js = Bundle(
    'https://unpkg.com/browse/instantclick@3.1.0/instantclick.js',
    'js/student.js',
    filters='jsmin',
...
staff_css = Bundle(
    'https://unpkg.com/browse/admin-lte@2.3.6/dist/css/AdminLTE.css',
    'https://unpkg.com/browse/admin-lte@2.3.6/dist/css/skins/skin-black-light.css',
