"""Import from App Engine Datastore

Revision ID: ef84eeb16962
Revises: None
Create Date: 2016-02-11 01:44:25.654043

"""

# revision identifiers, used by Alembic.
revision = 'ef84eeb16962'
down_revision = None
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('student', 'instructor', 'staff', 'grader', name='role'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['creator'], ['user.id'], name=op.f('fk_course_creator_user')),
